...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get calibrateTitle => 'వాయిస్ కాలిబ్రేట్ చేయండి';

  @override
  String calibrateIntro(int count) {
    return 'మీ మంత్రాన్ని మామూలుగా $count సార్లు జపించండి, ప్రతిసారి తర్వాత కొంచెం ఆగి. అప్పుడు Sadho వాయిస్ ఎంత కఠినంగా ఉండాలో నిర్ణయిస్తుంది, అన్నీ లెక్కించబడేలా, గది శబ్దం కాకుండా. ఏదీ రికార్డ్ చేయబడదు, ఉంచబడదు.';
  }

  @override
  String calibrateChantNow(int count) {
    return 'ఇప్పుడు మీ మంత్రాన్ని $count సార్లు జపించండి';
  }

  @override
  String calibrateHeard(int heard, int count) {
    return '$countలో $heard విన్నాను';
  }

  @override
  String calibrateSkipped(int count) {
    return 'ఒక జపం కాని $count శబ్దాలు వదిలివేయబడ్డాయి';
  }

  @override
  String get calibrateDone => 'కాలిబ్రేట్ అయింది';

  @override
  String calibrateDoneBody(int count) {
    return 'మొత్తం $count జపాలు లెక్కించబడతాయి; గది శబ్దం కాదు.';
  }

  @override
  String get calibrateStart => 'కాలిబ్రేషన్ ప్రారంభించండి';

  @override
  String get calibrateSave => 'కాలిబ్రేషన్ సేవ్ చేయండి';

  @override
  String calibrationSaved(String mantra) {
    return '“$mantra” కోసం కాలిబ్రేషన్ సేవ్ అయింది';
  }

  @override
  String get calibrateVoice => 'కాలిబ్రేట్ చేయండి';
  ...
  @override
  String get healthChannelTitle => 'అలారం నోటిఫికేషన్‌లు: \'అలర్ట్\'‌లో ఉంచండి';

  @override
  String get healthChannelBody =>
      '“సాధన అలారం”, “అలారాలు మరియు టైమర్‌లు” నోటిఫికేషన్‌లు స్క్రీన్‌పై కనిపించాలి, లేకపోతే లాక్ స్క్రీన్‌పై అలారం స్క్రీన్ కనిపించదు.';

  @override
  String get healthFixManualTitle => 'సెట్టింగ్‌లను మీరే తెరవండి';

  @override
  String get healthFixManualBody =>
      'ఫోన్ ఈ పేజీని తెరవలేదు. Samsung ఫోన్‌లో:\n1. సెట్టింగ్‌లు › యాప్‌లు › Sadho తెరవండి.\n2. నోటిఫికేషన్‌లు: అనుమతించండి, “సాధన అలారం”, “అలారాలు మరియు టైమర్‌లు” ను \'అలర్ట్\'‌లో ఉంచండి.\n3. అలారాలు & రిమైండర్‌లు: అనుమతించండి.\n4. బ్యాటరీ: అపరిమితం.\n5. పూర్తి-స్క్రీన్ నోటిఫికేషన్‌లు: సెట్టింగ్‌లు › యాప్‌లు › ⋮ › ప్రత్యేక యాక్సెస్ › Sadho ను అనుమతించండి.\n6. \'అంతరాయం కలిగించవద్దు\' యాక్సెస్: సెట్టింగ్‌లు › నోటిఫికేషన్‌లు › అంతరాయం కలిగించవద్దు › యాప్ యాక్సెస్ (నిశ్శబ్ద మోడ్‌కు మాత్రమే).';

  @override
  String get quietModeFailed =>
      'నిశ్శబ్ద మోడ్ \'అంతరాయం కలిగించవద్దు\'ను ఆన్ చేయలేకపోయింది';
