...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get paletteHighContrastName => 'उच्च कंट्रास्ट';

  @override
  String get paletteHighContrastBlurb =>
      'सबसे गहरा अंतर, आसानी से पढ़ने के लिए';

  @override
  String get malaNotificationChannel => 'माला काउंटर';

  @override
  String malaNotificationTitle(String count, String target) {
    return 'माला · $count / $target';
  }
  ...
  String get malaNotificationRunning =>
      'गिनने के लिए वॉल्यूम की दबाएं, स्क्रीन बंद होने पर भी।';

  @override
  String get malaNotificationDone => 'लक्ष्य पूरा 🙏';

  @override
  String get malaRingTitle => '🔔 माला पूरी';

  @override
  String malaRingBody(int target) {
    return 'आपने $target का लक्ष्य पूरा किया 🙏';
  }

  @override
  String get malaScreenOffUnavailable =>
      'इस फ़ोन पर स्क्रीन बंद होने पर गिनती शुरू नहीं हो सकी। वॉल्यूम की केवल तभी गिनेंगी जब Sadho खुला हो।';
  ...
  @override
  String get quietModeLabel => 'सत्र के दौरान अन्य सूचनाएँ शांत करें';

  @override
  String get quietModeSubtitle =>
      'सत्र चलते समय \'परेशान न करें\' (केवल अलार्म) चालू करता है, ताकि Sadho का अलार्म फिर भी बजे। बाद में आपकी अपनी सेटिंग वापस आ जाती है।';

  @override
  String get quietModeAccessTitle => '\'परेशान न करें\' एक्सेस दें';

  @override
  String get quietModeAccessBody =>
      'साधना के दौरान अन्य सूचनाएँ शांत करने के लिए Sadho को \'परेशान न करें\' एक्सेस चाहिए। अगली स्क्रीन पर Sadho ढूँढें और अनुमति दें। Sadho केवल सत्र चलते समय \'केवल अलार्म\' मोड चालू करता है और बाद में आपकी सेटिंग वापस कर देता है।';

  @override
  String get healthDndTitle => '\'परेशान न करें\' एक्सेस';
  ...
  @override
  String get quietModeFailed => 'शांत मोड \'परेशान न करें\' चालू नहीं कर सका';
  ...
  String calibrateOthersNow(int count) {
    return 'अब कुछ और $count बार बोलें';
  }

  @override
  String get calibrateOthersHint =>
      'दूसरे शब्द या कोई और मंत्र, उसी गति से, हर बार के बाद छोटा विराम।';

  @override
  String get calibrateSkipOthers => 'यह चरण छोड़ें';

  @override
  String calibrateResult(int mantra, int reps, int others, int otherReps) {
    return '$reps में से $mantra मंत्र गिने गए · $otherReps में से $others अन्य शब्द गिने गए';
  }

  @override
  String get voiceCalibratePrompt => 'बेहतर सटीकता के लिए कैलिब्रेट करें';

  @override
  String get voiceHonestNote =>
      'Voice सीखता है कि इस मंत्र का आपका जाप कैसा सुनाई देता है। यह लिखे हुए पाठ से उच्चारण की जाँच नहीं कर सकता।';
}
